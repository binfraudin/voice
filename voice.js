module.exports = function(request, response) {
    ...
    db.get('SELECT service, name FROM calls WHERE callSid = ?', [callSid], (err, row) => {
        ...
        var twourl = config.serverurl + '/stream/two';
        ...
        var ask = '<?xml version="1.0" encoding="UTF-8"?><Response><Gather timeout="8" numDigits="' + numdigits + '"><Say>' + name + ',</Say><Play>' + askurl + '</Play></Gather></Response>';
        /**
